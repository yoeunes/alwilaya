...
<html>
<head>
    <title>Réinitialiser du mot de passe</title>
...
<div class="elelment">
    ...
    <h2>Formulaire de réinitialiser du mot de passe</h2>
    <div class="element-main">
        <h1>Mot de passe oublié</h1>
        <form style="margin-top: 10px;" class="form-horizontal" role="form" method="POST" action="{{ url('/password/email') }}">
            {!! csrf_field() !!}
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                ...
                @if ($errors->has('email'))
                    <span class="help-block" style="color: #FF0000;text-align:center;">
